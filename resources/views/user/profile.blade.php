...
<section class="">
    ...
    <section class="items-center justify-center">
        <div class="h-full flex flex-col overflow-y-scroll">
            <div class="mb-5 pb-1 bg-blue-600 shadow-lg  rounded-b-3xl">
                <div class="flex  rounded-b-3xl bg-gray-100 dark:bg-gray-700 space-y-5 flex-col items-center py-7">
                    <img src="https://api.lorem.space/image/face?w=120&h=120&hash=bart89fe" alt="User" class="h-28 w-28 rounded-full">
                ...
                <div class="grid px-7 py-2  items-center justify-around grid-cols-3 gap-1 text-white divide-x divide-solid ">
                    <div class="col-span-1  px-3 flex flex-col items-center ">
                        <span class="text-lg font-bold">{{ $gadgets_count }}</span>
                        <span class="text font-medium 0">Gadgets</span>
                    </div>
                    <div class="col-span-1 flex items-center">
                        <a href="{{ route('user.edit', auth()->user()) }}" class="flex flex-col w-full text-center">
                            <span class="py-1 text-lg font-bold text-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="w-full h-6" viewBox="0 0 16 16">
                    ...
                    <div class="flex flex-col items-center ">
                        <a href="" class="text-center">
                            <button class="flex flex-col">
                                ...
                                <span class="mt-1 text-lg font-medium">Report</span>
                            </button>
                        </a>
                    </div>
                </div>
