...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        <div class="min-h-screen bg-gray-100">
            ...
            <!-- Page Content -->
            <main class="min-h-screen w-full bg-gray-100 text-blue-600" x-data="layout">
                <!-- header page -->
                <header class="flex w-full items-center justify-between bg-white p-4 pt-10">
                    <!-- logo -->
                    <div class="flex items-center space-x-2">
                        <button type="button" class="text-3xl" @click="asideOpen = !asideOpen"><i class="bx bx-menu"></i></button>
                        <h1 class="text-5xl">Techdahan</h1>
                    </div>
                ...
                <div class="flex">
                    <!-- aside -->
                    <aside class="flex w-80 flex-col space-y-2 border-r-2 border-gray-200 bg-white p-2" style="height: 90.5vh"
                        x-show="asideOpen">
                        ...
                        <a href="#" class="flex items-center space-x-1 rounded-md px-2 py-3 hover:bg-gray-100 hover:text-blue-600">
                            ...
                            <span>Manage Payment Transaction</span>
                        </a>
                        <form method="POST" action="http://techdahan.test/logout">
                            @csrf
                            <a class="flex items-center space-x-1 rounded-md px-2 py-3 hover:bg-gray-100 hover:text-blue-600" href="http://techdahan.test/logout" onclick="event.preventDefault(); this.closest('form').submit();">Log Out</a>
                        </form>
                    </aside>

                    <!-- main content page -->
                    <div class="w-full p-4">
                        <h2 class="w-full text-center text-4xl text-gray-500 mb-8">User List</h2>
                        <table class="min-w-max w-full table-auto">
                            ...
                            <tbody class="text-gray-600 text-sm font-light">
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex items-center justify-center">
                                            <span>eshal_rosas@email.com</span>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex items-center justify-center">
                                            <span>Inayawan, Cebu City</span>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6 text-center">
                                ...
                                <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex items-center justify-center">
                                            <span>anita_rodriquez@email.com</span>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex items-center justify-center">
                                            <span>Pardo, Cebu City</span>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6 text-center">
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex items-center justify-center">
                                            <span>taylan_bush@email.com</span>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex items-center justify-center">
                                ...
                                <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex items-center justify-center">
                                            <span>tarik_novak@email.com</span>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex items-center justify-center">
                                            <span>Tagunol, Cebu City</span>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6 text-center">
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex items-center justify-center">
                                            <span>oscar_howard@email.com</span>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex items-center justify-center">
                                            <span>Talisay, Cebu City</span>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6 text-center">
                                        <span class="bg-purple-200 text-purple-600 py-1 px-3 rounded-full text-xs">Active</span>
                                ...
                                <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex items-center justify-center">
                                            <span>melisa_moon@email.com</span>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex items-center justify-center">
                                            <span>Basak, Cebu City</span>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6 text-center">
                                        <span class="bg-yellow-200 text-yellow-600 py-1 px-3 rounded-full text-xs">Scheduled</span>
                                ...
                                <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex items-center justify-center">
                                            <span>kylan_dorsey@email.com</span>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex items-center justify-center">
